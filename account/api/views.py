...
class ChangePasswordView(UpdateAPIView):
    serializer_classes = ChangePasswordSerializer
    model = Account
    permission_classes = (IsAuthenticated)
    ...
    def update(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            new_password = serilaizer.data.get("new_password")
            confirm_new_password = serilaizer.data.get("confirm_new_password")
            if new_password != confirm_new_password:
                return Response({"new_password": ["New Password Must Match"]}, statust=status.HTTP_400_BAD_REQUEST)
